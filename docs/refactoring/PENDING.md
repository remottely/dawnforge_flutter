...
| 4 | FP3 — World & rendering (Flame) | same plan | walkable chunked world at 60fps with budget overlay | first slice done 2026-08-26 (FP3.1–3.3: game shell, AnimationCreator + SpriteAtlasLayout, renderers, InputHelper, keyboard-walkable field — proven in a widget test over real assets); remaining: FP3.4 chunked ground, FP3.5 grid collision, FP3.6 debug overlays + the on-device 60fps hand-run |
