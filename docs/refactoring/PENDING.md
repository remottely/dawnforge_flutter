...
| 3 | FP2.3–2.5 — sprites, translations, component-keys steps | same plan | steps ported, `--check` wired into suite | pending (FP2 core gate met 2026-08-26: emitter + pack slice + loader) |
