---
type: prop_crop_data
id: t2_prop_crop_vegetable_tomato
display_name_key: forge_almanac.03_farm.t2.t2_prop_crop_vegetable_tomato.display_name
description_key: forge_almanac.03_farm.t2.t2_prop_crop_vegetable_tomato.description

_sprites:
  atlas_position: [1, 118]
  frames_grid: [1, 6]

translations:
  display_name:
    en: "Tomato Crop"
    pt_BR: "Plantação de Tomate"
    es: "Cultivo de Tomate"
  description:
    en: "Tomato growing in tilled soil. Water it, wait, then cut it with a sickle — and plant it again after."
    pt_BR: "Tomate crescendo em terra arada. Regue, espere e corte com a foice — e plante de novo depois."
    es: "Tomate creciendo en tierra arada. Riégalo, espera y córtalo con la hoz — y vuelve a plantarlo después."
...
IVisualObjectData:
  spritesheet: "res://data/forge_almanac/03_farm/t2/sprites/t2_prop_crop_vegetable_tomato.png"
  frame_size: [1, 2]
  position_offset: [0, -0.1875]
...
stage_drop_configs:
  HARVESTABLE:
    - item_id: t2_item_buildable_seed_vegetable_tomato
      chance: 0.25
      min_amount: 1
      max_amount: 1
    - item_id: t2_item_consumable_vegetable_tomato
      chance: 1.0
      min_amount: 2
      max_amount: 3
---