---
type: prop_crop_data
id: t2_prop_crop_fruit_plum
display_name_key: forge_almanac.03_farm.t2.t2_prop_crop_fruit_plum.display_name
description_key: forge_almanac.03_farm.t2.t2_prop_crop_fruit_plum.description
...
translations:
  display_name:
    en: "Plum Tree"
    pt_BR: "Árvore de Ameixa"
    es: "Árbol de Ciruela"
  description:
    en: "A tree heavy with plum. Knock the fruit down with an axe — more grows back on its own."
    pt_BR: "Uma árvore carregada de ameixa. Derrube a fruta com o machado — nasce mais sozinha."
    es: "Un árbol cargado de ciruela. Tumba la fruta con el hacha — vuelve a crecer sola."
...
IVisualObjectData:
  spritesheet: "res://data/forge_almanac/03_farm/t2/sprites/t2_prop_crop_fruit_plum.png"
  frame_size: [1, 2]
  position_offset: [0, 0]
...
stage_drop_configs:
  HARVESTABLE:
    - item_id: t2_item_buildable_seed_fruit_plum
      chance: 0.25
      min_amount: 1
      max_amount: 1
    - item_id: t2_item_consumable_fruit_plum
      chance: 1.0
      min_amount: 2
      max_amount: 3

drops:
  - item_id: t2_item_logs_willow
    chance: 1.0
    min_amount: 1
    max_amount: 1
---