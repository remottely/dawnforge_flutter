...
id: t1_item_buildable_seed_fruit_apple
display_name_key: forge_almanac.02_workstations.04_seed_station.t1.t1_item_buildable_seed_fruit_apple.display_name
description_key: forge_almanac.02_workstations.04_seed_station.t1.t1_item_buildable_seed_fruit_apple.description

translations:
  display_name:
    en: "Apple Seeds"
    pt_BR: "Sementes de Maçã"
    es: "Semillas de Manzana"
  description:
    en: "Seeds of the apple plant. Put them in tilled soil and they grow.\n\nPlace it in the world to use it."
    pt_BR: "Sementes da planta de maçã. Ponha em terra arada e elas crescem.\n\nColoque no mundo para usar."
    es: "Semillas de la planta de manzana. Ponlas en tierra arada y crecen.\n\nSe coloca en el mundo para usarse."

ItemBuildableData:
  blueprint_id: t1_prop_crop_fruit_apple
...
IVisualObjectData:
  spritesheet: "res://data/forge_almanac/02_workstations/04_seed_station/t1/sprites/t1_item_buildable_seed_fruit_apple.png"
  frame_size: [1, 1]
  position_offset: [0, 0]
