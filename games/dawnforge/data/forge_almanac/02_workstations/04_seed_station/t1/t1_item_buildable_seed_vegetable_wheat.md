...
id: t1_item_buildable_seed_vegetable_wheat
display_name_key: forge_almanac.02_workstations.04_seed_station.t1.t1_item_buildable_seed_vegetable_wheat.display_name
description_key: forge_almanac.02_workstations.04_seed_station.t1.t1_item_buildable_seed_vegetable_wheat.description

translations:
  display_name:
    en: "Wheat Seeds"
    pt_BR: "Sementes de Trigo"
    es: "Semillas de Trigo"
  description:
    en: "Seeds of the wheat plant. Put them in tilled soil and they grow.\n\nPlace it in the world to use it."
    pt_BR: "Sementes da planta de trigo. Ponha em terra arada e elas crescem.\n\nColoque no mundo para usar."
    es: "Semillas de la planta de trigo. Ponlas en tierra arada y crecen.\n\nSe coloca en el mundo para usarse."

ItemBuildableData:
  blueprint_id: t1_prop_crop_vegetable_wheat
...
IVisualObjectData:
  spritesheet: "res://data/forge_almanac/02_workstations/04_seed_station/t1/sprites/t1_item_buildable_seed_vegetable_wheat.png"
  frame_size: [1, 1]
  position_offset: [0, 0]
...
ingredients:
  - id: t1_item_consumable_vegetable_wheat
    amount: 1
