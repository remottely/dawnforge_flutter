---
type: prop_crop_data
id: t1_prop_crop_flower_clover
display_name_key: forge_almanac.01_biomes.t1.props.t1_prop_crop_flower_clover.display_name
description_key: forge_almanac.01_biomes.t1.props.t1_prop_crop_flower_clover.description
biome_spawn_weight: 0.15

_sprites:
  atlas_position: [0, 161]
  frames_grid: [1, 3]
...
translations:
  display_name:
    ...
    es: "Trébol"
  description:
    en: "A clover standing open in the light. Pick it with your hands."
    pt_BR: "Uma flor de trevo aberta na luz. Colha com as mãos."
    es: "Una flor de trébol abierta a la luz. Recógela con las manos."
...
IVisualObjectData:
  spritesheet: "res://data/forge_almanac/01_biomes/t1/props/sprites/t1_prop_crop_flower_clover.png"
  frame_size: [1, 1]
  position_offset: [0, 0]
