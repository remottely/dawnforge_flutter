---
type: prop_crop_data
id: t1_prop_crop_herb_green_leaf
display_name_key: forge_almanac.01_biomes.t1.props.t1_prop_crop_herb_green_leaf.display_name
description_key: forge_almanac.01_biomes.t1.props.t1_prop_crop_herb_green_leaf.description
biome_spawn_weight: 0.15

_sprites:
  atlas_position: [0, 166]
  frames_grid: [1, 3]

translations:
  display_name:
    en: "Green Leaf Herb"
    pt_BR: "Erva de Folha Verde"
    es: "Hierba de Hoja Verde"
  description:
    en: "A patch of green leaf growing low to the ground. Cut it with a sickle."
    pt_BR: "Um pé de folha verde crescendo rente ao chão. Corte com a foice."
    es: "Una mata de hoja verde creciendo pegada al suelo. Córtala con la hoz."
...
IVisualObjectData:
  spritesheet: "res://data/forge_almanac/01_biomes/t1/props/sprites/t1_prop_crop_herb_green_leaf.png"
  frame_size: [1, 1]
  position_offset: [0, 0]
...
stage_drop_configs:
  PLANTED:
    - item_id: t1_item_buildable_seed_herb_green_leaf
      chance: 0.25
      min_amount: 1
      max_amount: 1
  SPROUT:
  ...
  BUDDING:
    - item_id: t1_item_buildable_seed_herb_green_leaf
      ...
      min_amount: 1
      max_amount: 1
    - item_id: t1_item_herb_green_leaf
      chance: 1.0
      min_amount: 1
      max_amount: 1
---