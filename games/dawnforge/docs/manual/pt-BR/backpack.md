...
Aperte **I** ou **Tab** para abrir a sua mochila. Aperte **Esc** — ou **I** de
novo — para fechar.

Os trinta bolsos estão lá, em seis fileiras de cinco. A barra de itens embaixo
da tela mostra dez desses mesmos bolsos por vez; é a mesma mochila vista por
uma janelinha menor, não uma segunda mochila.

## O mundo continua

Olhe atrás da mochila. As árvores continuam lá, embaçadas, e as coisas
continuam se mexendo. **O jogo não para quando você abre uma tela.** Você não
consegue andar nem usar nada com a mochila aberta, mas o tempo não te espera —
então não abra a mochila para se esconder de alguma coisa.

## Mudando as coisas de lugar

**Arraste uma coisa e solte em cima de outro bolso.** Três coisas podem
acontecer, e o jogo escolhe a certa:

- **O bolso está vazio** — a pilha inteira vai para lá.
- **O bolso tem a mesma coisa** — as pilhas se juntam. Se não couber tudo, o
  que sobrou fica onde estava.
- **O bolso tem outra coisa** — os dois trocam de lugar.

**Segure Shift enquanto arrasta** para levar só metade da pilha. Sete vira
quatro e três: quando a pilha não parte no meio certinho, a metade que você
está levando fica com o de sobra.

## Pousando uma coisa no chão

**Arraste uma coisa para fora da mochila e solte em qualquer lugar de fora** —
em cima do mundo embaçado. A pilha inteira cai no chão, no seu pé.

Ela não volta voando na hora. Tudo que você larga descansa meio segundo antes
