class InputsHUDConfig {
  ...
  static const List<Map<String, String>> inputGuide = [
    ...
    {"key": "←↑→↓ / AWSD", "desc": "Andar"},
    {"key": "Espaço", "desc": "Executar ação mão"},
    {"key": "Z", "desc": "Defesa / poder especial"},
    {"key": "X", "desc": "Interação com Objeto / NPC"},
    {"key": "Q/E", "desc": "Trocar item mão"},
    {"key": "U", "desc": "Desequipa mão (DEV)"},
    {"key": "I", "desc": "Abrir/Fechar Inventário"},
    {"key": "N", "desc": "Ir p/ próximo dia / Salvar jogo"},
