class TutorialInputsHUDDef {
  ...
  static const List<Map<String, String>> inputGuide = [
    ...
    {'key': 'C', 'desc': 'Mão - Executa (8 direções)'},
    {'key': 'Q / E', 'desc': 'Mão - Navega entre itens'},
    {'key': '1,2,...,0,-,+', 'desc': 'Mão - Navega entre itens'},
    {'key': 'U', 'desc': 'Mão - Desequipa'},
    ...
    {'key': 'T', 'desc': 'Adiciona itens no inventário (teste)'},
  ];
}
