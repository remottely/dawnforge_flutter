...
class MiniBoss extends SimpleEnemy with BlockMovementCollision, UseLifeBar {
  ...
  MiniBoss(this.initPosition)
    : super(
        ...
        size: Vector2(
          GameplayTileConstants.kCurrentTileSize * 0.68,
          GameplayTileConstants.kCurrentTileSize * 0.93,
        ),
    ...
    this.seePlayer(
      observed: (player) {
        ...
        this.seeAndMoveToPlayer(
          ...
          radiusVision: GameplayTileConstants.kCurrentTileSize * 3,
        );
      },
      radiusVision: GameplayTileConstants.kCurrentTileSize * 3,
    );
  ...
  void executeRangedAttack() {
    this.simpleAttackRange(
      ...
      size: Vector2.all(GameplayTileConstants.kCurrentTileSize * 0.65),
      damage: attack,
      speed: speed * 2.5,
      execute: () {
      ...
      collision: RectangleHitbox(
        size: Vector2(
          GameplayTileConstants.kCurrentTileSize / 3,
          GameplayTileConstants.kCurrentTileSize / 3,
        ),
        position: Vector2(10, 5),
      ),
      lightingConfig: LightingConfig(
        radius: GameplayTileConstants.kCurrentTileSize * 0.9,
        blurBorder: GameplayTileConstants.kCurrentTileSize / 2,
