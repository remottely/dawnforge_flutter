...
abstract class _KnightPlayerData {
  ...
  static const double _kDefaultLife = 200.0;
  static const double _kDefaultSpeed = GameplayConstants.kTileSizeDefault * 2.5;
  ...
  // Combate
  static const double _kDefaultAttackDamage = 25.0;
...
class KnightPlayer extends SimplePlayer with Lighting, BlockMovementCollision {
  ...
  // Variáveis de estado
  double _attackDamage = _KnightPlayerData._kDefaultAttackDamage;
  ...
  KnightPlayer(Vector2 position)
    : super(
        ...
        speed: _KnightPlayerData._kDefaultSpeed,
      ) {
