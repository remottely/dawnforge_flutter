...
class CustomPlayerModel extends DDHybridCombatPlayerModel {
  ...
  @override
  double get longVisionRadius => KnightPlayerConfig.kLongVisionRadius;
  ...
  @override
  int get shovelStaminaCost => KnightPlayerConfig.kShovelStaminaCost;

  @override
  int get wateringCanStaminaCost => KnightPlayerConfig.kWateringCanStaminaCost;

  @override
  int get seedStaminaCost => KnightPlayerConfig.kSeedStaminaCost;

  @override
  int get harvestBasketStaminaCost => KnightPlayerConfig.kHarvestBasketStaminaCost;
