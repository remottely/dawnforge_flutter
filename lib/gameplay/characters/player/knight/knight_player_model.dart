...
///
/// Note: The Knight character shares the same resource system as other player
/// characters but uses a specialized dual-hand equipment system for combat.
class KnightPlayerModel {
  ...
  /// Creates a knight player model with optional initial state values.
  ///
  ...
  KnightPlayerModel({
    ...
    bool? initialHasKey,
  }) : _currentStamina = initialStamina ?? KnightPlayerConfig.kMaxStamina,
       _currentEnergy = initialEnergy ?? KnightPlayerConfig.kMaxEnergy,
  ...
  bool get canExecutePrimaryAttack =>
      _currentStamina >= KnightPlayerConfig.kPrimaryAttackStaminaCost;
  ...
  bool get canExecuteFireballAttack =>
      _currentStamina >= KnightPlayerConfig.kFireballAttackStaminaCost;
  ...
  bool get canExecuteToolAction =>
      _currentEnergy >= KnightPlayerConfig.kToolActionEnergyCost;
  ...
  void regenerateStamina() {
    _currentStamina = (_currentStamina + KnightPlayerConfig.kStaminaIncrement)
        .clamp(0, KnightPlayerConfig.kMaxStamina);
  }
  ...
  void restoreEnergy() {
    _currentEnergy = KnightPlayerConfig.kMaxEnergy;
  }
