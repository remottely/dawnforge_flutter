...
class KnightPickaxeHandPreset {
  ...
  static KnightHandItemConfig create() {
    ...
    return KnightHandItemConfig(
      ...
      slotConfigurations: {
        KnightHandSlot.right: KnightHandSlotConfig(
          attachmentOffset: attachmentOffset,
          facingRightOffset: mirroredDirectionalOffset,
          facingLeftOffset: directionalOffset,
        ),
        KnightHandSlot.left: KnightHandSlotConfig(
          attachmentOffset: attachmentOffset,
          facingRightOffset: directionalOffset,
          facingLeftOffset: mirroredDirectionalOffset,
        ),
      },
    );
  }
