...
class SmallburgPlayerView<
  C extends SmallburgPlayerController<M>,
  M extends DDFarmPlayerModel
>
    extends DDFarmPlayerView<C, M> {
  SmallburgPlayerView({required super.position, required super.model})
    : super(config: SmallburgPlayerDef.viewConfig);
  ...
  C createFarmController({
    ...
    return SmallburgPlayerController<DDFarmPlayerModel>(
          model: model,
