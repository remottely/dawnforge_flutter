...
--strike --stage18 --stage19 --stage20 --ride --stage21a --kind=5..8 --biome=N --stage21b --weather=clear|rain|storm|snow --journal=0..3 --host --join=<ip> --wait-peer --trace`, and for the look: `--sun=k --amb=k
