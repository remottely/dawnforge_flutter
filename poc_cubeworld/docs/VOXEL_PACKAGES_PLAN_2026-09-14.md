...
| VP4 Release prep `0.0.1` | in progress (VP4.1a–c: silent failures throw, API trimmed, every public symbol documented; VP4.2: an example in each package) | `dart pub publish --dry-run` clean for both; a standalone example runs without the POC |
