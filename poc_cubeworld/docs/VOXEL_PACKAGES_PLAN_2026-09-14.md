...
| VP4 Release prep `0.0.1` | in progress (VP4.1a–c: silent failures throw, API trimmed, every public symbol documented) | `dart pub publish --dry-run` clean for both; a standalone example runs without the POC |
