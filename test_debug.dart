...
void main() {
  ...
  print('Before JSON: enemies_defeated achievement = ${manager.getAchievementProgress("enemies_defeated")}');
  ...
  print('Decoded achievements type: ${decodedJson['achievements'].runtimeType}');
  ...
  print('After fromJson: enemies_defeated achievement = ${manager.getAchievementProgress("enemies_defeated")}');
